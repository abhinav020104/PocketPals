    ...
    const clickHandler = async () => {
        try {
            const order = await axios({
                method: "post",
                url: "https://pocketpals-server.codewithabhinav.in/api/v1/account/order",
                data: {
            ...
            var options = {
                ...
                handler: async function (response) {
                    ...
                    const validateRes = await axios({
                        method:"post",
                        url:"https://pocketpals-server.codewithabhinav.in/api/v1/account/validate",
                        data:response
                    }
                    );
                    ...
                    const updatedBalance = await axios({
                        method:"put",
                        url:"https://pocketpals-server.codewithabhinav.in/api/v1/account/topup",
                        data:topUpdata,
                    })
                    toast.dismiss();
